defmodule Adapter.Registry.Helpers do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      defp create_bot({messenger_name, bot_uid, token}, state) do
      ...
      defp stop_process(:bot, pid, name), do: Adapter.MessengerSupervisor.stop(pid, name)

      defp stop_process(:messenger, pid, _name), do: Adapter.MessengersSupervisor.stop(pid)
